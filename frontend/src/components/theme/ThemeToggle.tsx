...
// Build a horizontal hue spectrum for the slider background.
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-label="切换主题"
        className="flex h-8 w-8 items-center justify-center rounded-md text-sm text-muted-foreground hover:bg-accent hover:text-foreground"
      >
        {mounted ? (isDark ? "☾" : "☀") : "☀"}
      </button>

      {open && (
        <div className="absolute right-0 top-10 z-50 w-72 rounded-lg border border-border bg-popover p-3 shadow-lg">
          <div className="mb-3">
